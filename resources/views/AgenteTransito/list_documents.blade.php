                            ...
                            <table class="table table-vcenter table-mobile-md card-table">
                                ...
                                <tbody id="tbl_permisos">
                                    @foreach ($documents as $d)
                                        <tr>
                                           <!-- <td data-label="Title">
                                                <div>{{ $d->id_primary }}</div>
                                            </td> -->
                                            <td data-label="Title">
                                                <div><span> <i class="fa-solid fa-calendar"></i></span> {{ $d->titulo }}</div>
                                            </td>
                                            <td>
                                                <a href="javascript:void(0)"
                                                    onclick="descargar_archivo_oc({{ $d->id_primary }},{{ $d->id_related }})">
...
<svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
    ...
    <path d="M9 6l6 6l-6 6" />
            ...
            function descargar_archivo_oc(id_primary, id_related) {
                var url = `{{env('URL_MOVILIDAD')}}/orden_cuerpo/show_pdf_orden_cuerpo/${id_primary}/${id_related}`;
                console.log(url);
