		...
		<div class="main-container container-fluid">
			...
			<div class="col-md-12 col-lg-12 col-xl-12 bg-white">
				...
				<!--<div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
					<img src="/valex/assets/img/logo-movilidad.png" class="sign-favicon-a ht-40" alt="logo">
				</div>-->
						...
						<div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
							<div class="card-sigin">
								<div class="main-signup-header">
									<h2 align="center" class="fon-size-titu">INTRANET</h2>
									...
									<form class="style_width" id="login-form" method="POST" enctype="multipart/form-data">
										...
										<div class="form-group">
											<div class="input-group has-validation">
												...
												<input id="txt-usuario" name="txt-usuario" class="form-control" placeholder="Usuario" type="text">
										...
										<div class="form-group">
											<div class="input-group has-validation">
												...
												<input id="txt-clave" name="txt-clave" class="form-control" placeholder="Clave" type="password">
												<div class="invalid-feedback">
													Please choose a username.
												</div>
											</div>
