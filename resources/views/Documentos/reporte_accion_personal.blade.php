    ...
    <div class="border_body">
                ...
                <table class="table_header">
                    <tr>
                        <td class="header_table_title_logo">
                            <img src="img/movilidad_manta.png" class="logo_movilidad_manta" alt="Movilidad Manta" />
                        </td>
                        ...
                        <td class="header_table_title_data">
                            ...
                            <p><span class="text_bold">No.</span> 002-2024</p>
                            <p><span class="text_bold">Fecha:</span> 15 de enero del 2024</p>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <main>
            <div class="table_tipo_accion_personal_div">
                <table class="table_tipo_accion_personal">
                    <tr>
                        ...
                        <td class="table_tipo_accion_personal_opcion">
                            RESOLUCION <img src="img/cuadradoconx.png" class="cuadrado_con_x" alt="Cuadrado con x" /> 
                        </td>
                    </tr>
                </table>
            </div>
                ...
                <table class="table_datos_empleado">
                    <tr>
                        <td class="table_datos_empleado--nombre" colspan="3">
                            <p><span class="text_bold">MOLINA VÉLEZ</span></p>
                            <p>APELLIDOS</p>
                        </td>
                        <td class="table_datos_empleado--nombre" colspan="3">
                            <p><span class="text_bold">MOLINA VÉLEZ</span></p>
                    ...
                    <tr>
                        <td class="table_datos_empleado--otros_datos table_datos_empleado--otros_datos_header" colspan="2">
            ...
            <div class="text-accion-div">
                ...
                <p>
                    Con Memorando MMEP-GGE-MEM-150120241512, el Gerente General Abg. Kenny Muñoz Cañizares, dispone aprobar dos días de vacaciones al Ing. Jimmy Piloso Rodríguez, Director de Talento Humano, atendiendo solicito mediante memorando MEMORANDO MMEP-DTH-MEM-110120241701, de fecha 15 de enero de 2024. En relación a lo expuesto y de acuero a lo establecido en la Ley Orgánica de Empresas Públicas (en adelante LOEP), publicada en la Ley 0, del Registro Oficial Suplemento No. 48, de 16 de octubre de 2009, establece en el artículo 21: SUBROGACIÓN O ENCARGO.- Cuando por disposición de la ley o por orden escrita de autoridad competente, un servidor deba subrogar a superiores jerárquicos o ejercer un encargo en los que perciban mayor remuneración mensual unificada, éste recibirá la diferencia de la remuneración mensual unificada, obtenida entre el valor que percibe al subrogante y el valor que perciba el subrogado, durante el tiempo que dure el reemplazo y a partir de la fecha en que se inicia tal encargo o subrogación, sin perjuicio del derecho del titular a recibir la remuneración que le corresponda . Por lo ante expuesto se emite la presente acción de personal para regularizar el encargo como DIRECTORA DE TALENTO HUMANO ENCARGADA.
                </p>
            </div>
                ...
                <table class="table_opciones_accion">
                    <tr>
                        ...
                        <td class="table_opciones_accion--check">
                            <span class="cuadrado_seleccion">&#9633;</span>
                        </td>
                        <td class="table_opciones_accion--opcion">
                            TRASLADO
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="table_opciones_accion--check">
                            <img src="img/cuadradoconx.png" class="cuadrado_con_x" alt="Cuadrado con x" />
                        </td>
                        <td class="table_opciones_accion--opcion">
                            LICENCIA
                        </td>
                    ...
                    <table class="table_proceso_talento_humano">
                        ...
                        <tr>
                            <td class="table_proceso_talento_humano--text_firma" colspan="3">
                                <span class="text_bold">Nombre: Ing. Carlos Jimmy Piloso Rodríguez</span>
                            </td>
                        </tr>
                        <tr>
                            <td class="table_proceso_talento_humano--text_firma" colspan="3">
            ...
            <div class="datos_fima_autoridad_delegada">
                <table class="table_firma_autoridad_delegada">
                    <tr>
                        ...
                        <td class="table_firma_autoridad_delegada--datos"><span class="text_bold">f.</span>______________________________________________</td>
                        <td class="table_firma_autoridad_delegada--blanco"></td>
                    </tr>
                    <tr>
                        <td class="table_firma_autoridad_delegada--blanco"></td>
                        <td class="table_firma_autoridad_delegada--datos"><span class="text_bold">Nombre: Ing. Carlos Jimmy Piloso Rodríguez</span></td>
                        <td class="table_firma_autoridad_delegada--blanco"></td>
                    </tr>
                    <tr>
                        <td class="table_firma_autoridad_delegada--blanco"></td>
                        <td class="table_firma_autoridad_delegada--datos"><span class="text_bold">DELEGADO DE AUTORIDAD NOMINADORA</span></td>
                        <td class="table_firma_autoridad_delegada--blanco"></td>
                    </tr>
                    <tr>
                        <td class="table_firma_autoridad_delegada--blanco"></td>
                        <td class="table_firma_autoridad_delegada--datos"><span class="text_bold">Resolución No. 004-GG-EPMMM-2022</span></td>
                        <td class="table_firma_autoridad_delegada--blanco"></td>
                    </tr>
                </table>
            </div>
                ...
                <div class="firma_talento_humano">
                    ...
                    <table class="table_firma_talento_humano">
                        <tr>
                            ...
                            <td class="table_firma_talento_humano--borde"></td>
                            <td class="table_firma_talento_humano--fecha"><span class="text_bold">Fecha</span></td>
                            <td class="table_firma_talento_humano--borde"></td>
                        </tr>
                        <tr>
                            <td class="table_firma_talento_humano--firma_sufijo" colspan="4"><span class="text_bold">Responsable del Registro</span></td>
                        </tr>
                    </table>
                </div>
                <div class="firma_recibido">
                    ...
                    <table class="table_firma_recibido">
                        <tr>
                            ...
                            <td class="table_firma_recibido--firma"><span class="text_bold">f.</span>________________________________________</td>
                            <td class="table_firma_recibido--blanco"></td>
                        </tr>
                        <tr>
                            <td class="table_firma_recibido--firma_sufijo" colspan="3"><span class="text_bold">GEMA MOLINA VELEZ</span></td>
                        </tr>
                    </table>
                </div>
            </div>
