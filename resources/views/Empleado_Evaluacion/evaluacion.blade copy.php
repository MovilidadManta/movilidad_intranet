            ...
            <div class="av-column-12">
                <div class="breadcrumb-content">
                    ...
                    <ol class="breadcrumb-list">
                        ...
                        <li class="active">Evaluacion de Desempeño</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div data-title="Loading ..." class="rt-row rt-content-loader layout1 tpg-even ">
                    <div class="rt-col-md-4 rt-col-sm-6 rt-col-xs-12 even-grid-item rt-grid-item margin-b-no" data-id="1943">
                        <div class="rt-holder sha-no">
                            <div class="rt-detail pad-no">
                                <h5 class="entry-title text-ali-titu align-ce" >
                                    <a class="color-ti" target="_blank"  href="/evaluacion">Navarrete Mendoza Yandry Moises</a>
                                </h5>
                                <div class="align-ce">
                                    <span class="date color-des"><i class="far fa-calendar-alt"></i>
                                        <strong clas="">Analista de Tecnologia 3</strong>
                                    </span>
                                </div>
                                <!--<div class="tpg-excerpt">
                                    <p class="text-ali-des">dddddddddd</p>
                                </div>
                    ...
                    <!--<div class="rt-col-md-4 rt-col-sm-6 rt-col-xs-12 even-grid-item rt-grid-item margin-b-no">
                        <div class="rt-holder sha-no">
                            <div class="rt-detail pad-no">
                                <h5 class="entry-title text-ali-titu align-ce">
                                    <a class="color-ti" target="_blank" href="https://portalciudadano.manta.gob.ec/">Portal Cuidadano ↗</a>
                                </h5>
                                <div class="align-ce">
                                    <span class="date"><i class="far fa-calendar-alt"></i>
                                        <strong>Accede a los tramites en línea desde casa</strong>
                                    </span>
                                </div>
                                <div class="tpg-excerpt">
                                    <p class="text-ali-des">dddddddddd</p>
                    ...
                    <!--<div class="rt-col-md-4 rt-col-sm-6 rt-col-xs-12 even-grid-item rt-grid-item margin-b-no">
                        <div class="rt-holder sha-no">
                            <div class="rt-detail pad-no">
                                <h5 class="entry-title text-ali-titu align-ce">
                                    <a class="color-ti align-ce" target="_blank" href="https://srienlinea.sri.gob.ec/">Servicios SRI ↗</a>
                                </h5>
                                <div class="align-ce">
                                    <span class="date"><i class="far fa-calendar-alt"></i>
                                        <strong>Accede a los servicios en línea del SRI</strong>
                                    </span>
                                </div>
                                <div class="tpg-excerpt">
                                    <p class="text-ali-des">dddddddddd</p>
