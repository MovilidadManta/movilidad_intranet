        ...
        <div class="av-columns-area wow fadeInUp service-row" style="visibility: visible; animation-name: fadeInUp;">
            <div class="av-column-4 av-md-column-6 mb-1 p-0">
                <div class="service-item">
                    ...
                    <div class="service-content">
                        <h5 class="service-title"><a href="/rendicion-cuenta">TRANSPARENCIA</a></h5>
            ...
            <div class="av-column-4 av-md-column-6 mb-1 p-0">
                <div class="service-item">
                    ...
                    <div class="service-content">
                        <h5 class="service-title"><a href="/nosotro">QUIENES SOMOS</a></h5>
            ...
            <div class="av-column-4 av-md-column-6 mb-1 p-0">
                <div class="service-item">
                    ...
                    <div class="service-content">
                        <h5 class="service-title"><a href="/noticia">NOTICIAS</a></h5>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active marg-bo">
                    <div class="cards-wrapper" style="display: flex;">
                        ...
                        <div class="card sha-no-index margin-b-no img-border-ra">
                            <div class="rt-holder ">
                                <div class="rt-img-holder">
                                    <a class="" href="https://web.movilidadmanta.gob.ec/2022/05/10/transporte-terrestre-transito-y-seguridad-vial-2/">
                                        <img src="http://192.168.0.100:8000/imagenes_noticias/noticia202206215006.jpeg" class="img-border-ra tam-img-no rt-img-responsive jetpack-lazy-image jetpack-lazy-image--handled" alt="" data-lazy-loaded="1" loading="eager"></a>
                                </div>
                                <div class="rt-detail pad-no">
                                    <h5 class="entry-title text-ali-titu">
                                        <a class="color-ti" href="https://web.movilidadmanta.gob.ec/2022/05/10/transporte-terrestre-transito-y-seguridad-vial-2/">{{$data1->no_titulo}}</a>
                                    </h5>
                                    <div class="post-meta-user  "><span class="date"><i class="far fa-calendar-alt"></i><strong> {{$data1->no_fecha}}</strong></span></div>
                                    <div class="tpg-excerpt">
                                        <p class="text-ali-des">{{$data1->no_descripcion}}</p>
                                    </div>
                                    <div class="post-meta btn-ri">
                                        <span class="read-more">
                                            <a class="btn-noticia" href="./noticia/" target="_blank">Leer mas</a>
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card img-border-ra sha-no-index">
                            <div class="rt-img-holder">
                                <a class="" href="/noticia/{{$data1->id_noticia_hash}}" target="_blank">
                                    <img src="/imagenes_noticias/{{$data1->no_ruta_foto}}" class="img-border-ra  tam-img-no rt-img-responsive jetpack-lazy-image jetpack-lazy-image--handled" alt="" data-lazy-loaded="1" loading="eager"></a>
                            </div>
                            
                            <div class="card-body">
                                <h5 class="card-title text-ali-titu">{{$data1->no_titulo}}</h5>
                                <div class="post-meta-user  "><span class="date"><i class="far fa-calendar-alt"></i><strong>{{$data1->no_fecha}}</strong></span></div>
                                <p class="card-text text-ali-des">{{$data1->no_descripcion}}</p>
                                <a class="btn-noticia btn-ri" href="/noticia/{{$data1->id_noticia_hash}}" target="_blank">Leer mas</a>
                            </div>
                        </div>
                        @endforeach
                    </div>
                    ...
                    <div class="cards-wrapper" style="display: flex;">
                        ...
                        <!--<div class="card">
                            <div class="image-wrapper">
                                <img src="http://192.168.0.100:8000/imagenes_noticias/noticia202206215006.jpeg" class="card-img-top" alt="...">
                            </div>
                            <div class="card-body">
