    ...
    <div class="page custom-index">
                                ...
                                <ul class="nav nav-item  navbar-nav-right ms-auto">
                                    <li class="">
                                        <div class="dropdown  nav-item">
                                            <a href="javascript:void(0);"
                                                ...
                                                <span
                                                    class="avatar country-Flag me-0 align-self-center bg-transparent"><img
                                                        src="https://m.media-amazon.com/images/I/51sMyQo0kAL._AC_SX679_.jpg"
                                                        alt="img"></span>
                                                <div class="my-auto">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-start  dropdown-menu-arrow"
                                                ...
                                                <a href="javascript:void(0);" class="dropdown-item d-flex">
                                                    <span class="avatar  me-3 align-self-center bg-transparent"><img
                                                            src="/valex/assets/img/flags/germany_flag.jpg"
                                                            alt="img"></span>
                                                    <div class="d-flex">
                                                ...
                                                <a href="javascript:void(0);" class="dropdown-item d-flex">
                                                    <span class="avatar me-3 align-self-center bg-transparent"><img
                                                            src="/valex/assets/img/flags/italy_flag.jpg"
                                                            alt="img"></span>
                                                    <div class="d-flex">
                                                ...
                                                <a href="javascript:void(0);" class="dropdown-item d-flex">
                                                    <span class="avatar me-3 align-self-center bg-transparent"><img
                                                            src="/valex/assets/img/flags/russia_flag.jpg"
                                                            alt="img"></span>
                                                    <div class="d-flex">
                                                ...
                                                <a href="javascript:void(0);" class="dropdown-item d-flex">
                                                    <span class="avatar  me-3 align-self-center bg-transparent"><img
                                                            src="/valex/assets/img/flags/spain_flag.jpg"
                                                            alt="img"></span>
                                                    <div class="d-flex">
                                        ...
                                        <div class="dropdown-menu">
                                            <div class="menu-header-content bg-primary text-start">
                                                <div class="d-flex">
                                                    <h6 class="dropdown-title mb-1 tx-15 text-white fw-semibold">
                                                        Notificaciones</h6>
                                                    <span
                                                        class="badge rounded-pill bg-warning ms-auto my-auto float-end">Marcar
                                                        todas las leidas</span>
                                                </div>
                                                <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">
                                                    Tu tienes 4 notificaciones sin leer</p>
                                            </div>
                                            <div class="main-notification-list Notification-scroll">
                                                <a class="d-flex p-3 border-bottom" href="javascript:void(0);">
                                                    ...
                                                    <div class="ms-3">
                                                        <h5 class="notification-label mb-1">Se agrego a Martha Lorem
                                                        </h5>
                                    ...
                                    <li class="dropdown main-profile-menu nav nav-item nav-link">
                                        <a class="profile-user d-flex" href=""><img alt=""
                                                src="/imagenes_empleados/{{Session::get('ruta_foto')}}"></a>
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" href="/cerrar-sesion"><i class="bx bx-log-out"></i>
                                                Salir</a>
                                        </div>
                                    </li>
                ...
                <aside class="app-sidebar sidebar-scroll">
                    <div class="main-sidebar-header active">
                        <a class="desktop-logo logo-light active" href="/home"><img
                                src="/valex/assets/img/logo-movilidad.png" class="img-logo main-logo" alt="logo"></a>
                        <a class="desktop-logo logo-dark active" href="/home"><img
                                src="/valex/assets/img/brand/logo-white.png" class="main-logo" alt="logo"></a>
                        <a class="logo-icon mobile-logo icon-light active" href="/home"><img
                                src="/valex/assets/img/brand/favicon.png" alt="logo"></a>
                        <a class="logo-icon mobile-logo icon-dark active" href="/home"><img
                                src="/valex/assets/img/brand/favicon-white.png" alt="logo"></a>
                    </div>
                    <div class="main-sidemenu">
                            ...
                            <div class="dropdown user-pro-body">
                                <div class="">
                                    <img alt="user-img" class="avatar avatar-xl brround"
                                        src="/imagenes_empleados/{{Session::get('ruta_foto')}}"><span
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item" href="/home"><svg xmlns="http://www.w3.org/2000/svg"
                                        class="side-menu__icon" viewBox="0 0 24 24">
                                        <path d="M0 0h24v24H0V0z" fill="none" />
                                        <path d="M5 5h4v6H5zm10 8h4v6h-4zM5 17h4v2H5zM15 5h4v2h-4z" opacity=".3" />
                                        <path
                                            d="M3 13h8V3H3v10zm2-8h4v6H5V5zm8 16h8V11h-8v10zm2-8h4v6h-4v-6zM13 3v6h8V3h-8zm6 4h-4V5h4v2zM3 21h8v-6H3v6zm2-4h4v2H5v-2z" />
                                    </svg><span class="side-menu__label">Inicio</span><span
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li><a class="slide-item" href="/nomina">Nómina</a></li>
                                    <li><a class="slide-item" href="/credencial">Credencial</a></li>
                                    <li><a class="slide-item" href="/acuerdo">Acuerdos</a></li>
                                    <li><a class="slide-item" href="/hoja-ruta">Paz y Salvo</a></li>
                                    <li><a class="slide-item" href="/evaluacion">Evaluación</a></li>
                                    <li><a class="slide-item" href="/correo">Correo</a></li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                ...
                                <ul class="slide-menu">
                                    <li><a class="slide-item" href="/admin/nosotro">Gestion Mision Vision</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li><a class="slide-item" href="/consolidado">Gestion Consolidado</a></li>
                                    <li><a class="slide-item" href="/consolidado-reporte">Reporte Consolidado</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li><a class="slide-item" href="/admin-rendicion-cuenta">Gestion Rendición de
                                            Cuenta</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a class="slide-item" href="/admin-lotaip">Gestion Lotaip</a></li>
                                    <li><a class="slide-item" href="/admin-literal-lotaip">Gestion Literal Lotaip</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <!--<li><a class="slide-item" href="/admin-registrar-lotaip">Registrar Lotaip</a></li>-->
                                    <li><a class="slide-item" href="/admin-noticia">Noticia</a></li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                ...
                                <ul class="slide-menu">
                                    <li><a class="slide-item" href="/admin-contactano">Gestión Contáctanos</a></li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                ...
                                <ul class="slide-menu">
                                    <li><a class="slide-item" href="/admin-slider-index">Gestión Slider</a></li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                ...
                                <ul class="slide-menu">
                                    <li><a class="slide-item" href="/admin-cooperativa">Gestion Cooperativa</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li><a class="slide-item" href="/admin-destino">Gestion Destino</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li><a class="slide-item" href="/admin-turismo">Gestion Turismo</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li><a class="slide-item" href="/admin-turismo">Gestion Eventos</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li><a class="slide-item" href="/admin-proceso">Gestión Procesos</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li><a class="slide-item" href="/admin-catalogo">Gestión Catalogo</a></li>
                                    <li><a class="slide-item" href="/admin-inventario">Gestión Inventario</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li><a class="slide-item" href="/reporte-nomina">Reporte de Nómina</a></li>
                                    <li><a class="slide-item" href="/admin-ip">IP's</a></li>
                                    <li><a class="slide-item" href="/admin-reporte-equipo">Reporte de Equipos</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li><a class="slide-item" href="/usuario">Gestión Usuarios</a></li>
                                </ul>
                            </li>
                            @endif
                            ...
                            <!--<li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                    ...
                                    <span class="side-menu__label">Tecnología</span>
                                    <i class="angle fe fe-chevron-down"></i>
                                </a>
                                <ul class="slide-menu">
                                    <li><a class="slide-item" href="/usuario">Usuarios</a></li>
                                </ul>
                            </li>-->
                            <!--<li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                                    ...
                                    <span class="side-menu__label1">Talento Humano</span>
                                    <i class="angle fe fe-chevron-down"></i>
                                </a>
                                <ul class="slide-menu">
                                    <li><a class="slide-item" href="icons.html">Nomina </a></li>
                                    <li><a class="slide-item" href="icons.html">Mision y Vision </a></li>
        ...
        <div class="main-footer ht-45 footer">
            <div class="container-fluid pd-t-0 ht-100p">
                <span> Copyright © 2022 <a href="www.sgi.movilidadmanta.gob.ec" class="text-primary">Movilidad EP
                    </a><span class="fa fa-heart text-danger"> Diseñado </span> por <a href="www.movilidadmanta.gob.ec">
                        TIC Movilidad EP </a> Todos los derechos reservados.</span>
            </div>
        </div>
        <!-- Footer closed -->
