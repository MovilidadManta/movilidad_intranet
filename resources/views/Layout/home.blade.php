                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        <div class="mt-0 text-center">
                            ...
                            <h2 class="text-white mb-0">{{$t_empleado}}</h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        <div class="mt-0 text-center">
                            ...
                            <h2 class="text-white mb-0">{{$t_usuario}}</h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        <div class="mt-0 text-center">
                            ...
                            <h2 class="text-white mb-0">{{$t_noticia}}</h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        <div class="mt-0 text-center">
                            ...
                            <h2 class="text-white mb-0">{{$t_cooperativa}}</h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        <div class="mt-0 text-center">
                            ...
                            <h2 class="text-white mb-0">{{$t_lugar_turistico}}</h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        <div class="mt-0 text-center">
                            ...
                            <h2 class="text-white mb-0">{{$t_centro_comercial}}</h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        <div class="mt-0 text-center">
                            ...
                            <h2 class="text-white mb-0">{{$t_servicio}}</h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        <div class="mt-0 text-center">
                            ...
                            <h2 class="text-white mb-0">{{$t_slider}}</h2>
                        </div>
                    </div>
                </div>
            </div>
