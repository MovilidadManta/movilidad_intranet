        ...
        <table border="1" class="" style=" width:100%; height: auto;">
            <tr class="">
                <td class=" center negrita" colspan="4" style="height: 130px;">
                    ...
                    <br>
                    <br>
                    <span class="f_titulo08">PERMISO OFICIAL POR HORAS</span>
                    <br>
                    <br>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="4" class="">
                    <span class="f_titulo08">
                        Se concede permiso oficial por horas para ausentarse temporalmente de la entidad, siempre que se encuentre debidamente respaldado y autorizado por Gerencia y/o Talento Humano. No se establece límite de horas, conforme a la necesidad debidamente justificada y registrada.
                    </span>
                </td>
            </tr>
            <tr class="gris ">
                <td colspan="1" class="negrita center"><span class="f_titulo">DESDE LAS: </span></td>
                <td class="negrita center"> <span class="f_titulo">HASTA LAS:</span></td>
                <td colspan="2" class="negrita center"><span class="f_titulo">DEL DIA:
                    </span> </td>
            </tr>
            <tr>
                <td colspan="1" style="height: 30px;">
                    <span class="f_titulo"> {{$p['h_inicio']}} </span>
                </td>
                <td> <span class="f_titulo">{{$p['h_final']}}</span></td>
                <td colspan="2">
                    <span class="f_titulo">
                        {{$p['desde']}}
                    </span>
            ...
            <tr>
                <td colspan="4" style="height: 60px;">
                    <span class="f_titulo06 negrita">
                        DETALLAR DOCUMENTO QUE JUSTIFICA LA SOLICITUD:
                    </span>
                    <br>
                    <br>
                    {{$p['observacion']}}
            ...
            <tr class="gris">
                <td colspan="4" class="center" style="height: 100px;">
                    ...
                    <span class="f_titulo08"> En el caso de Matriculación de hijos, Otros justificados y Asunto Personal,
                        deben presentarse en la DATH en forma previa a su utilización.
                    </span>
                </td>
            </tr>
        </table>
