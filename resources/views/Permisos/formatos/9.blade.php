        ...
        <table border="1" class="" style=" width:100%; height: auto;">
            <tr class="">
                <td class=" center negrita" colspan="4" style="height: 130px;">
                    ...
                    <br>
                    <br>
                    <span class="f_titulo08">SOLICITUD DE VACACIONES</span>
                    <br>
                    <br>
                </td>
            </tr>
            ...
            <tr class="gris ">
                <td colspan="1" class="negrita center"><span class="f_titulo">DIAS QUE SOLICITA: </span></td>
            ...
            <tr class="gris">
                <td colspan="4" class="center" style="height: 100px;">
                    ...
                    <span class="f_titulo08">Toda solicitud de vacaciones deberá ser presentada a la Dirección Administrativa de Talento Humano con unmínimo de quince (15) días de anticipación. </span>
                </td>
            </tr>
        </table>
    </div>
