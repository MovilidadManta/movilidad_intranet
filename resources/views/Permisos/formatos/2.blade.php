        ...
        <table border="1" class="" style=" width:100%; height: auto;">
            <tr class="">
                <td class=" center negrita" colspan="4" style="height: 130px;">
                    ...
                    <br>
                    <br>
                    <span class="f_titulo08">PERMISO DE SALIDA POR HORAS</span>
                    <br>
                    <br>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="4" class=""><span class="f_titulo08">Art. 33 LOSEP. - Tiene PERMISO para salir de la oficina, por el tiempo de hasta dos horas;
                    </span>
                    <span class="f_titulo08">
                        Art. 34 LOSEP.- Permisos Imputables a vacaciones (Máximo 8 horas, mínimo 4 horas)
                    </span>
                </td>
            </tr>
            <tr class="gris ">
