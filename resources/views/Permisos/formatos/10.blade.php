        ...
        <table border="1" class="" style=" width:100%; height: auto;">
            <tr class="">
                <td class=" center negrita" colspan="4" style="height: 130px;">
                    ...
                    <br>
                    <br>
                    <span class="f_titulo08">SOLICITUD DE LICENCIA POR HOSPITALIZACIÓN</span>
                    <br>
                    <br>
                </td>
            </tr>
            ...
            <tr>
                <td class="gris"><span class="f_titulo">TIPO DE ENFERMEDAD: </span></td>
                <td colspan="3" class="f_titulo">{{$p['tipo_enfermedad']}}</td>
            </tr>
            <tr>
            ...
            <tr class="gris ">
                <td colspan="1" class="negrita center"><span class="f_titulo">DIAS / HORAS QUE SOLICITA: </span></td>
            ...
            <tr class="center">
                ...
                @else
                <td colspan="1" style="height: 30px;"><span class="f_titulo"> {{$p['total_horas']}}</span></td>
                @endif
                <td> <span class="f_titulo">{{$p['desde']}} T {{$p['h_inicio']}}</span></td>
                <td colspan="2"><span class="f_titulo">{{$p['hasta']}} T {{$p['h_final']}}</span> </td>
            </tr>
            <tr>
            ...
            <tr class="gris">
                <td colspan="4" class="center" style="height: 100px;">
                    ...
                    <span class="f_titulo08">La Licencia o permiso por enfermedad se concederá siempre y cuando el servidor la justifique
                        dentro del término de tres días de haberse producido, mediante la certificación respectiva. </span>
                </td>
            </tr>
        </table>
    </div>
