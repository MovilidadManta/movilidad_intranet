        ...
        <table border="1" class="" style=" width:100%; height: auto;">
            <tr class="">
                <td class=" center negrita" colspan="4" style="height: 130px;">
                    ...
                    <br>
                    <br>
                    <span class="f_titulo08">PERMISO OFICIAL POR DÍAS</span>
                    <br>
                    <br>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="4" class="">
                    <span class="f_titulo08">
                        Se concede permiso oficial por días para ausentarse de la entidad por trámites o gestiones fuera de la institución, siempre que se encuentre debidamente respaldado y autorizado por Gerencia y/o Talento Humano. No se establece límite de días, conforme a la necesidad debidamente justificada y registrada.
                    </span>
                </td>
            </tr>
            <tr>
            ...
            <tr class="gris">
                <td colspan="4" class="center" style="height: 100px;">
                    ...
                    <span class="f_titulo08">La licencia o permiso por calamidad se concederá siempre y cuando el servidor la justifique dentro del término de tres
